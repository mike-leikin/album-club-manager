    ...
    <main className="min-h-screen bg-gray-50 text-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-500">Sign in to access the curator dashboard</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 space-y-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-3 font-medium text-gray-900 transition hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
          >
